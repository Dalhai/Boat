# Agent Instructions
You must respect established designs, requirements and functional instructions of all markdown files in the "agents/" folder.
You must, at the end of executing a task, update those markdown files according to the changes implemented.
